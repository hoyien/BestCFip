...
const CONFIG = {
  ...
  excludeReg: /官网|官方|以下|校园|灾|群|禁止|自定义|邀请|返利|循环|客服|网站|网址|获取|订阅|流量|总计|到期|机场|下次|重置|重新|设置|版本|官址|过期|已用|联系|邮箱|工单|贩卖|通知|倒卖|防止|地址|频道|无法|说明|提示|特别|访问|支持|教程|关注|更新|作者|加入|超时|收藏|福利|好友|网易|网易云|APP|TOTAL|EXPIRE|EMAIL|Panel|Channel|Author|Traffic/,
